...
i = np.radians(30)  # Inclination in radians, e.g., 28.5 degrees
...
#number of orbits
n_orbits = 2  # Number of orbits to simulate
...
# Load the map image
map_img = plt.imread("flatMap.png")
...
y_img = (np.log(np.tan(PI / 4 + lat / 2)) / (2 * PI) + 0.5) * img_height
